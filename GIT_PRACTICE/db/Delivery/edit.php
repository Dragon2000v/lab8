...
require_once($_SERVER['DOCUMENT_ROOT'] . '/Delivery/App/Repository/MySQLSuplRepository.php');
...
$rep = new MySQLSuplRepository();
$services = new SupplierService($rep);
    ...
    <div class="form-group">
       ...
       <script>
            function proverka() {
                ...
                return alert("Контракт успешно обновлён!");
                } else {
...
<?php
$service->updateContract($number, $supplier, $title, $note);
?>
</body>
</html>
